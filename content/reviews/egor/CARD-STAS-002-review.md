...
- **Verdict comment (Egor-human):** applicability customer/supplier, точный
  РДИК_0474, состояние outdated ОКТМО и все steps принимаются как source-backed по
  portal:588559:1. Required facts достаточно узкие; при несовпадении — обычный
  RAG/уточнение. Routing TH8/ST75/L2 принимается как независимо воспроизводимый,
  recommended_recipient=null корректен. handoff_required=false принимается.
